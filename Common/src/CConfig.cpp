  ...
  if (val_software == SU2_COMPONENT::SU2_CFD) {
    ...
    switch (Kind_Solver) {
      ...
      case MAIN_SOLVER::NEMO_NAVIER_STOKES:
        ...
        if (Kind_FluidModel == SU2_NONEQ){
          if ((GasModel != "N2") && (GasModel != "AIR-5") && (GasModel != "AIR-7") && (GasModel != "AIR-11") && (GasModel != "ARGON"))
          SU2_MPI::Error("The GAS_MODEL given is unavailable using CSU2TCLIB. Choose one of the options: N2, AIR-5, AIR-7, AIR-11, or ARGON.", CURRENT_FUNCTION);
        }
        break;
